...
import tpl_toolbar_download_dialog from "templates/toolbar_download_dialog.html";
import "styles/download_dialog.scss";
import 'jed';

const { Backbone, _ } = converse.env;
const URL_REGEX = /\b(https?\:\/\/|www\.|https?:\/\/www\.)[^\s<>]{2,200}\b\/?/g;

converse.plugins.add('converse-download-dialog', {
    ...
    */
    dependencies: ["converse-chatboxes", "converse-disco", "converse-chatview", "converse-muc-views", "converse-chatboxviews"],

    overrides: {
        ChatBoxView: {
            events: {
                'click .toggle-download-dialog': 'downloadAttachements',
            },
            ...
            renderToolbar () {
                ...
                this.el.querySelector('.chat-toolbar').insertAdjacentHTML(
                    'beforeend',
                    tpl_toolbar_download_dialog({'download_dialog_title': __('Start Download-Dialog')}));
            }
        },
    ...
    initialize () {
        ...
        const DOWNLOAD_DIALOG = {
            downloadAttachements () {
                console.log("downloadAttachements was called");
