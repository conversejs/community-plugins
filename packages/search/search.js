(function (root, factory) {
    ...
    var SearchDialog = null, searchDialog = null, _converse, dayjs, html, _, __, Model;
    ...
    converse.plugins.add("search", {
        ...
        'initialize': function () {
            ...
            _converse.api.listen.on('getToolbarButtons', function(toolbar_el, buttons)
            {
                ...
                buttons.push(html`
                    <button class="plugin-search" title="${__('Search conversations for keywords')}" @click=${performSearch} .chatview=${this.chatview}/>
                        <svg style="width:20px; height:20px; fill:var(--chat-toolbar-btn-color);" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" enable-background="new 0 0 16 16" xml:space="preserve"> <g><path d="M 2,30l 18,0 c 1.104,0, 2-0.896, 2-2l0-2.7 c 0.426-0.204, 0.824-0.448, 1.198-0.73l 6.138,6.138 c 0.196,0.196, 0.452,0.292, 0.708,0.292s 0.512-0.098, 0.708-0.292c 0.39-0.39, 0.39-1.024,0-1.414l-6.142-6.142 C 25.472,21.988, 26,20.56, 26,19c0-2.788-1.642-5.174-4-6.3L 22,2 c0-1.104-0.896-2-2-2L 2,0 C 0.896,0,0,0.896,0,2l0,26 C0,29.104, 0.896,30, 2,30z M 19,24C 16.244,24, 14,21.756, 14,19S 16.244,14, 19,14S 24,16.244, 24,19S 21.756,24, 19,24z M 2,2l 18,0 l0,10 L 5.286,12 C 4.576,12, 4,12.448, 4,13C 4,13.552, 4.576,14, 5.286,14l 8.826,0 C 13.038,15.048, 12.326,16.444, 12.1,18L 5,18 C 4.448,18, 4,18.448, 4,19 C 4,19.552, 4.448,20, 5,20l 7.1,0 c 0.49,3.388, 3.376,6, 6.9,6c 0.342,0, 0.67-0.054, 1-0.1L 20,28 L 2,28 L 2,2 zM 5,8l 12,0 C 17.552,8, 18,7.552, 18,7C 18,6.448, 17.552,6, 17,6l-12,0 C 4.448,6, 4,6.448, 4,7C 4,7.552, 4.448,8, 5,8z"></path></g></svg>
                    </button>
                `);
        ...
        'overrides': {
            ChatBoxView: {
                parseMessageForCommands: function(text) {
                    ...
                    if (command === "search")
                    {
                        searchDialog = new SearchDialog({ 'model': new converse.env.Model({view: view, keyword: match[2]}) });
                        searchDialog.show();
                        return true;
                    }
                    else
    ...
    function performSearch(ev)
    {
        ...
        searchDialog = new SearchDialog({ 'model': new Model({view: this.chatview}) });
