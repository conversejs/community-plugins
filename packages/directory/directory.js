(function (root, factory) {
    ...
    var performDirectory = function(ev)
    {
        ...
        if (!directoryDialog) directoryDialog = new DirectoryDialog({ 'model': new Model({}) });
